export default function Footer() {
  return (
    <footer className="mt-10 border-t border-marca-100 py-8 text-center">
      ...
      <p className="font-display text-marca-600 font-600">Eventos y Celebraciones GT</p>
      <p className="text-xs text-gray-400 mt-1">
        © {new Date().getFullYear()} — Hecho con cariño en Guatemala
      </p>
    </footer>
  )
}
